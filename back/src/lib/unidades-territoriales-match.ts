...
export const ALIAS_COLONIA_A_UT: Record<string, string[]> = {
  ...
  "barrio san lucas": ["san lucas", "los robles"],
  "barrio del nino jesus": ["del nino jesus"],
  "barrio oxtopulco universidad": ["oxtopulco universidad", "altillo", "acasulco universidad"],
  ...
  "ex ejido de san francisco culhuacan": [
    ...
    "ampliacion san francisco culhuacan",
  ],
  ...
  "bosques de tetlameya": ["bosques de tetlameya", "santa ursula bosques de tetlameya", "media luna"],
  ...
  "campestre churubusco": ["campestre churubusco", "ex ejido de churubusco"],
  "el caracol": ["el caracol"],
  "el centinela": ["el centinela", "centro urbano tlalpan"],
  "jardines de coyoacan": ["jardines de coyoacan", "las cabanas"],
  "los cipreses": ["los cipreses", "villas de coyoacan"],
  "olimpica": ["olimpica", "santa ursula coyoacan"],
  "paseos de taxquena": ["paseos de taxquena", "taxquena"],
  ...
  "pueblo de santa ursula coapa": ["pueblo santa ursula coapa", "las trojes coapa"],
  "viejo ejido de santa ursula coapa": [
    "viejo ejido santa ursula coapa",
    "el vergel de coyoacan",
    "infonavit el hueso",
  ],
